...
class InsightsViewModel(private val taskRepository: TaskRepository, private val expenseRepository: ExpenseRepository, private val diaryRepository: DiaryRepository, private val aiRepository: AiRepository) : ViewModel() {
    ...
    private fun loadStats() { viewModelScope.launch {
        val weekStart = DateTimeUtils.startOfWeekEpochDay(); val weekEnd = DateTimeUtils.endOfWeekEpochDay()
        val tasksCompleted = taskRepository.countCompletedBetween(weekStart * 86_400_000L, (weekEnd + 1) * 86_400_000L)
