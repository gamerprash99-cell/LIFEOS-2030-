...
class TaskRepository(private val dao: TaskDao, private val appContext: Context) {
    ...
    suspend fun createTask(
        ...
        dao.upsert(
            TaskEntity(
                ...
                priority = priority, category = category, reminderEpochMillis = reminderEpochMillis,
                repeatRule = repeatRule, repeatDaysCsv = repeatDaysCsv,
    ...
    suspend fun createFromAiExtraction(
        titles: List<String>, dueDateEpochDay: Long?, sourceType: String, sourceId: String
