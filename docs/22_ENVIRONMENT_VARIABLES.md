> **CURRENT STATUS — 2026-09-11:** The current app requires no AI API key and no runtime cloud secret. Historical provider-key examples below are not part of the current build.
