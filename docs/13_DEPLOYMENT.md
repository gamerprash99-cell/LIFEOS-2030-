> **CURRENT IMPLEMENTATION — 2026-09-11:** Release builds must remain offline-first. There is no external AI API key or cloud service dependency in the current app.
