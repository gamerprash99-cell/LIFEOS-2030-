> **CURRENT VERIFIED STATUS — 2026-09-11:** LifeOS AI is an offline local Intelligence Engine. No API key, HTTP client, cloud endpoint or external model is required by the app.
