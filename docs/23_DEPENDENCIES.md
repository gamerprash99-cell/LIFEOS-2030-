...
| org.jetbrains.kotlinx:kotlinx-serialization-json | 1.7.3 | JSON serialization | Direct | BackupRepository.kt, NoteBlock.kt, NoteBlock.kt | High | Low |
...
| com.squareup.okhttp3:okhttp | — | HTTP client | **Not present in current build** | Historical cloud-AI implementation only | N/A | N/A |
