> **CURRENT IMPLEMENTATION — 2026-09-11:** Ignore older cloud-AI setup examples in this historical guide. The current LifeOS app does not require or transmit data to Anthropic or any other external AI provider.
